...
body{
   ...
   <body>
     <div class="container text-center" >
     	<br><br>
    	<h1 class="text-center text-success text-uppercase animateuse" > Technical Quiz World</h1>
    	<br><br><br><br>
      <table class="table text-center table-bordered table-hover">
         ...
         $Resultans = 0;
            ...
            $finalresult = " INSERT INTO `scoretable` ( `name`, `totalq`, `score`) VALUES ( '$name', '20', '$Resultans'); ";
        ...
        <a href="stud_panel.php" class="btn btn-success">BACK </a>
      </div>
   </body>
</html>
