<?php
   ...
   if(!isset($_SESSION['username'])){
   	header('location:stud_panel.php');//here need to change to name
   }
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1>Welcome</h1>
      <p>Following quiz provides Multiple Choice Questions (MCQs) related to C, java, python Programming Framework. You will have to read all the given answers and click over the correct answer.</p>
      <hr>
      <h3>Test</h3>
      <p>Find out which careers, languages, and courses suit your personal interests and strengths best.</p>
     
      
    </div>
    <?php
      $result = mysqli_query($con,"SELECT * FROM scoretable WHERE name=$enrollment");
    ...
    <div class="col-sm-2 sidenav">
      <div class="well">
        ...
        <p>Java score:<?php echo $row["score"]; ?>/20</p>
      </div>
      <div class="well">
        <p>Python score:</p>
      </div>
...
<div class="row" style="margin:15px;">
  ...
  <center><a href="one_time_test.php">  <button type="submit" name="name" class="button">Take Quiz</button> </a></center>
  </div>
 
  <div class="column" id="c">
    <img src="images//c.jpg" alt="c" style="width:100%; height:150px; ">
    <center><a href="s_soon.php">  <button class="button">Take Quiz    </button></a></center> 
   </div>
